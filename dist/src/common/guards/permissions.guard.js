...
let PermissionsGuard = class PermissionsGuard {
    ...
    async canActivate(context) {
        ...
        if (!user || !user.roleId) {
            throw new common_1.ForbiddenException('Access denied: Authenticated user context not found.');
        }
        ...
        if (!roleWithPermissions) {
            throw new common_1.ForbiddenException('Access denied: Target user role does not exist.');
        }
        ...
        if (!hasAllPermissions) {
            throw new common_1.ForbiddenException('Access denied: You do not possess the required permissions.');
        }
        return true;
    }
};
